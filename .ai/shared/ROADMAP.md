...
Status: ACTIVE DEVELOPMENT — WR-127 / WR-128 CLOSED after audited integration and full canonical-main canary; Track B custom ranking paused
Current-state snapshot: 2026-09-21, WR-D043 closes WR-127 and WR-128; active-only registry is empty at this closure checkpoint. Verify live main, registry and CI before future routing.
