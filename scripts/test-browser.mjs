...
for (const [width, height] of [[390, 844], [1280, 900]]) {
  ...
  assert.match(observed.knownMarket.visibleDetail, /Market timing index \(heuristic\): \d+ \/ 100/);
...
const wr127Truthful = wr126BoardPressure.every(item =>
  ...
  item.knownMarket.visibleDetail.includes('Market timing index (heuristic):') &&
